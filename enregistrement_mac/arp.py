...
# Memes exclusions que extraction_mac/docmac.py, plus la diffusion et le
# multicast : ce ne sont jamais les MAC d'un appareil a enregistrer.
...
def normaliser(brut, separateur=":", majuscules=True):
    ...
    hexa = re.sub(r"[^0-9A-Fa-f]", "", brut or "")
